<template>
    <li class="comment-wrapper animate slideInLeft ">
        ...
        <div class="msg has-shadow">
            <div class="msg-body"><p class="name">{{message.author}} <span class="date">{{posted_at}}</span></p>
...
<script>
    export default {
        ...
        computed: {
            ...
            avatar() {
                return `https://api.adorable.io/avatars/48/${this.message.author}@adorable.io.png`
            }
        }
    }
</script>
